globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file:///Users/supawatputayanan/Documents/GitHub/workshop-frontend/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { provider, isWindows } from 'file:///Users/supawatputayanan/Documents/GitHub/workshop-frontend/node_modules/std-env/dist/index.mjs';
import { defineEventHandler, handleCacheHeaders, createEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseStatus, getRequestHeader, setResponseHeader, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, getQuery, createError } from 'file:///Users/supawatputayanan/Documents/GitHub/workshop-frontend/node_modules/h3/dist/index.mjs';
import { createRenderer } from 'file:///Users/supawatputayanan/Documents/GitHub/workshop-frontend/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import devalue from 'file:///Users/supawatputayanan/Documents/GitHub/workshop-frontend/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { renderToString } from 'file:///Users/supawatputayanan/Documents/GitHub/workshop-frontend/node_modules/vue/server-renderer/index.mjs';
import { createFetch as createFetch$1, Headers } from 'file:///Users/supawatputayanan/Documents/GitHub/workshop-frontend/node_modules/ofetch/dist/node.mjs';
import destr from 'file:///Users/supawatputayanan/Documents/GitHub/workshop-frontend/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file:///Users/supawatputayanan/Documents/GitHub/workshop-frontend/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///Users/supawatputayanan/Documents/GitHub/workshop-frontend/node_modules/hookable/dist/index.mjs';
import { snakeCase } from 'file:///Users/supawatputayanan/Documents/GitHub/workshop-frontend/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/supawatputayanan/Documents/GitHub/workshop-frontend/node_modules/defu/dist/defu.mjs';
import { hash } from 'file:///Users/supawatputayanan/Documents/GitHub/workshop-frontend/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, withQuery } from 'file:///Users/supawatputayanan/Documents/GitHub/workshop-frontend/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/supawatputayanan/Documents/GitHub/workshop-frontend/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/supawatputayanan/Documents/GitHub/workshop-frontend/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/supawatputayanan/Documents/GitHub/workshop-frontend/node_modules/radix3/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/Users/supawatputayanan/Documents/GitHub/workshop-frontend/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/supawatputayanan/Documents/GitHub/workshop-frontend","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/supawatputayanan/Documents/GitHub/workshop-frontend/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/supawatputayanan/Documents/GitHub/workshop-frontend/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/supawatputayanan/Documents/GitHub/workshop-frontend/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _lazy_NVFiFa = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_NVFiFa, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_NVFiFa, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('/Users/supawatputayanan/Documents/GitHub/workshop-frontend/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getStaticRenderedHead = () => Promise.resolve().then(function () { return _virtual__headStatic$1; }).then((r) => r.default || r);
const getServerEntry = () => import('/Users/supawatputayanan/Documents/GitHub/workshop-frontend/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
...
const _virtual__headStatic = {"headTags":"<meta charset=\"utf-8\">\n<title>JOB Interesting</title>\n<meta name=\"viewport\" content=\"width=device-width, initial-scale=1\">\n<link rel=\"stylesheet\" href=\"https://fonts.googleapis.com/css2?family=Open+Sans:wght@300&display=swap\">\n<script src=\"/js/bootstrap.bundle.min.js\"></script>","bodyTags":"","bodyTagsOpen":"","htmlAttrs":"","bodyAttrs":""};
